...
document.querySelector(".UpDown").addEventListener("click", function(e){
    ...
    var Down=Math.round((parseFloat(window.getComputedStyle(document.querySelector(`.flex_line`)).bottom)) - screenHeight);
    var Line_Up=parseFloat(window.getComputedStyle(document.querySelector('.UpDown')).bottom);
    var stepEnd=Line_Up;
    document.querySelector(`.flex_line`).style.bottom=`${stepEnd}px`;
    document.querySelector('.Down').style.bottom =`${stepEnd}px`
    document.querySelector(`.UpDown`).style.bottom=`${Down}px`;
});

document.querySelector(".Down").addEventListener("click", function(e){
    var screenHeight=document.querySelector("html").clientHeight;
    var Down=Math.round((parseFloat(window.getComputedStyle(document.querySelector(`.UpDown`)).border)) - screenHeight);
    var Line_Up=parseFloat(window.getComputedStyle(document.querySelector('.flex_line')).bottom);
    var stepEnd=Line_Up;
    document.querySelector(`.flex_line`).style.bottom=`${Down}px`;
    document.querySelector('.Down').style.bottom =`${Down}px`
    document.querySelector(`.UpDown`).style.bottom=`${stepEnd}px`;
});
